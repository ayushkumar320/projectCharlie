      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-slate-300 text-lg leading-relaxed">
            <p>
              Welcome to{" "}
              <span className="text-amber-400 font-semibold">Codeshack</span>,
            ...
            <div className="grid md:grid-cols-2 gap-6 my-8">
              <div className="bg-slate-800/50 p-6 rounded-lg border border-amber-400/20 hover:border-amber-400/50 transition-all duration-300">
                <h3 className="text-2xl font-bold text-amber-400 mb-3">GLUG</h3>
